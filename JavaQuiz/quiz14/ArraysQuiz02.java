...
public class ArraysQuiz02 {

    public static String[] solution(String[] A_LEN, String[] B_LEN) {
    ...
    public static void main(String[] args) {
        String[] A_LEN = {"A", "B", "C", "D", "E"};
        String[] B_LEN = {"X", "Y", "Z"};

        System.out.println(Arrays.toString(solution(A_LEN, B_LEN)));
